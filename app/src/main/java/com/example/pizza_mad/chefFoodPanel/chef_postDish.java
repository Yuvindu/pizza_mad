...
public class chef_postDish extends AppCompatActivity {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ref.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                        ...
                        public void onSuccess(Uri uri) {
                            ...
                            firebaseDatabase.getInstance().getReference("FoodDetails").child(District).child(City).child(Area).child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child(RandomUID)
    ...
    private boolean isValid() {
        ...
        if(TextUtils.isEmpty(quantity)){
            ...
            qty.setError("Enter number of Pizzas or Items");
        }else{
